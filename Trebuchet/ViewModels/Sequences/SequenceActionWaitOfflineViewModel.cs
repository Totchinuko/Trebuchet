...
[SequenceAction(typeof(SequenceActionWaitOffline))]
public class SequenceActionWaitOfflineViewModel(SequenceActionWaitOffline action) : 
    SequenceActionViewModel<SequenceActionWaitOfflineViewModel, SequenceActionWaitOffline>(action)
{
